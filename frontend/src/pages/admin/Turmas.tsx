        ...
        <AdminLayout>
            <div className="max-w-6xl mx-auto space-y-6">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1">Gerencie as turmas do sistema</p>
                </div>
                        ...
                        <CardContent>
                            <form onSubmit={handleSubmit} className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <Input placeholder="Ex: 1 Ano A" value={nomeTurma} onChange={(e) => setNomeTurma(e.target.value)} disabled={mutation.isPending} />
                                </div>
                        ...
                        <Card className="overflow-hidden">
                            ...
                            <CardContent className="p-0">
                                {isLoading ? (
                                    ...
                                    <p className="p-6 text-center text-muted-foreground">Nenhuma turma cadastrada</p>
                                ) : (
